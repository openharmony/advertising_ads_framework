...
private:
    ...
    static bool ParseMultiSlotsRequest(napi_env env, napi_value argv[], MultiSlotsRequestContext *context);

    static bool ParseMultiSlotsOption(napi_env env, napi_value argv[], MultiSlotsRequestContext *context);
